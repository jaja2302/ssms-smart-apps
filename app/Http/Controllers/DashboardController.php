...
class DashboardController extends Controller
{
    ...
    public function exportPdfTaksasi($est, $date,  $web = null)
    {
        ...
        foreach ($queryDataNew as $key => $value) {
            foreach ($value as $key1 => $value1) {
                ...
                $Taksasi[$key][$key1]['bjr'] = $value2['bjr_sensus'] != 0 ? $value2['bjr_sensus'] : $value2['bjr'];
        ...
        foreach ($Taksasi as $key => $value) {
            ...
            $final_bjr_temp = $sum_bjr / count($value);
            $final_bjr = round($final_bjr_temp, 2);
    ...
    public function exportPdfTaksasiTest($est, $date,  $web = null)
    {
        $estate_input = $est;
        $tgl = $date;
        ...
        $pdf = pdf::loadview('taksasi.cetak_test', [
            'est' => $estate_input,
            'tgl' => $tgl,
            'namaEstate' => strtoupper($queryEstate->nama),
            'wil' => $romanNumeral,
